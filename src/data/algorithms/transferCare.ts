...
export const transferCareAlgorithm = {
  ...
  results: {
    ...
    'T-C': {
      ...
      recommendation: '모터 구동식 전동형 기립보조기기 고려를 추천합니다. 벨트를 등에 지지하고 기립을 도와 이승을 돕습니다.',
      reason: '자리이동 기능평가 결과 중등도 이상의 어려움이 있으며 하지 근력은 불충분하여 체중 지지가 불가능하나 상체 잔존 근력이 남아있어 협조가 가능한 상황입니다.'
    },
    'T-D': {
      id: 'T-D',
      title: 'T-D. 비전동형 기립보조기기 고려',
      description: '체중 지지가 어렵고 상체도 가누기 힘든 상태이므로 대상자를 안전하게 안아 올리거나 슬링으로 감싸 이동을 돕는 보조 수준이 높은 비전동형 기립보조기기 또는 고안전 리프트를 고려해야 합니다.',
      recommendation: '탑승식 수동형 기립보조차 또는 전적으로 몸을 고정해주는 기립 보조 기기, 혹은 전신슬링 리프트 전환을 고려하세요.',
      reason: '체중 지지가 불가능하고 스스로 상체를 가누거나 지탱하기도 어려워 전동 기립 시 낙상 위험이 높으며 더 전반적인 신체 지지가 요구됩니다.'
    },
    'T-E': {
      id: 'T-E',
      title: 'T-E. 천장 고정형 리프트 고려',
      description: '체중 지지는 어렵고 전신 슬링 지원이 필요한 중등도 이상 상태이며 주거 혹은 시설 환경상 천장 레일 공사가 가능하고 반복적인 사용 빈도가 높을 때 적합한 솔루션입니다.',
    ...
    'T-F': {
      ...
      recommendation: '벽면에 회전 가능한 관절 암 타입의 리프트를 장착하여 침대에서 휠체어로 이동시키는 벽 고정식 리프트 설치를 고려하세요.',
    ...
    'T-G': {
      ...
      recommendation: '바퀴 달린 다목적 하부 프레임과 유압 혹은 전동 실린더가 장착된 이동식 리프트 고려를 추천합니다.',
